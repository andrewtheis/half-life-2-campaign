...
function PlayerInitialSpawn(um)
	if !file.Exists("half-life_2_campaign/shown_help.txt") then
		ShowHelp()
		file.Write("half-life_2_campaign/shown_help.txt", "You've viewed the help menu in Half-Life 2 Campaign.")
	end
